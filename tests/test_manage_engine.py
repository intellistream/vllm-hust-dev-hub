...
class ManageEngineGuardTests(unittest.TestCase):
    ...
    def test_env_template_exposes_host_managed_docker_knobs(self) -> None:
        ...
        self.assertIn("VLLM_ENGINE_HOST_CACHE_DIR=/data/cache", template)
    ...
    def test_engine_launcher_bootstraps_missing_container(self) -> None:
        ...
        self.assertIn('host_cache_dir="${VLLM_ENGINE_HOST_CACHE_DIR:-$HOME/.cache}"', script)
        self.assertIn('HOST_CACHE_DIR="$host_cache_dir"', script)
